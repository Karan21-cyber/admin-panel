...
function RecentSales({ width }: { width: string }) {
  return (
    <div
      className={`recent-sales-components ${width} flex flex-wrap flex-col p-5  gap-10 bg-white shadow-sm rounded-2xl`}
    >
      <div className="recent-header flex justify-between items-center">
        <div className="recent-highlight flex flex-col gap-1">
          <h1 className="recent-titile text-xl font-semibold text-dark-text">
            Today&#39;s Sales
          </h1>
          <h1 className="recent-summary text-base font-normal text-[#737791]">
            Sales Summery
          </h1>
        </div>
